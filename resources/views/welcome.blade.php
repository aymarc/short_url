...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .login-wrp form input::placeholder { 
            /* Chrome, Firefox, Opera, Safari 10.1+ */
            color: #2d434f;
            opacity: 1; /* Firefox */
            }
            .login-wrp form input[type='submit']{
                background: #52778c;
                width:120px;
                margin-top:5px;
                font-weight:bold;
            }
            .login-wrp form input[type='submit']:hover{
                background:#5b8399;
            }
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 ">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="card login-wrp">
                    <div className="card-header">
                        <h1 id="title-c">Sign In 
                    ...
                    <div className="card-body">
                        <form id="sign-in-form">
                            ...
                            <div className="form-group">
                                <input type="submit" value="Login" id="signin-form-action" className="btn float-right login_btn"  />
                            </div>
                        </form>
                        <form id="sign-up-form" >
                            ...
                            <div className="form-group">
                                <input type="submit" value="Register" id="signup-form-action" className="btn float-right login_btn"  />
                            </div>
                        </form>
                    </div>
                         <div className="card-footer">
                        <div className="d-flex justify-content-center links">
                            <a id="footer-message">Don't have an account?</a> <a id="sign-up" href="#" >Sign Up</a>
                        </div>
        ...
        <script>
                (()=>{
                    ...
                    const formTitle = document.getElementById("title-c");
